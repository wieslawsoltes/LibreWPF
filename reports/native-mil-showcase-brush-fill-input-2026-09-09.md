# Showcase rectangular brush-fill input — 2026-09-09

## Acceptance path

Application/action: the full package Showcase's resource tab contains
`ShowcaseDrawingImageBrushBorder`, a 36x36 Border with a DrawingImage-backed ImageBrush.
...
Showcase's Fluent theme, not an open-path arrow requiring new stroke support. This
...
This closes the identified Showcase rectangular brush-fill input connection in code,
