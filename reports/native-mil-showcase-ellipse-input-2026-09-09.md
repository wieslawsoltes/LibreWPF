# Showcase full-ellipse native input — 2026-09-09

## Acceptance dependency

Application/action: open the existing full package Showcase's Shapes tab and preserve
selection and native input admission for `ShowcaseShapeEllipse`, including content
...
product path is unchanged; paired managed regressions cover the actual Showcase
...
This closes the identified Showcase ellipse admission branch in implementation, not
