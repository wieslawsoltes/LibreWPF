# MVP built-in effect input — 2026-09-09

## Acceptance dependency

The existing package MVP has `MvpBlurEffectBorder` (Gaussian radius 2.5) and
`MvpDropShadowEffectBorder` (radius 9, depth 4, direction 315, opacity 0.55).
...
Canonical MIL scene 9817 covers the MVP effect parameters plus zero blur.
...
routing. Continue the same MVP's source input path: ordinary text/chrome guideline
