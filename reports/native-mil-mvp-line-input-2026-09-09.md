# MVP ordinary line input — 2026-09-09

## Acceptance dependency

The package MVP's `MvpShapeLine` in `samples/ProGPU.Wpf.MvpApp/MainWindow.xaml`
...
the actual MVP line. Matched managed fixtures cover those values and the
...
This closes the identified producer rejection for the MVP's ordinary line; it
...
cache/effect families and native host query routing remain open. The MVP's
closed stroked `MvpShapePath` is the next concrete source path to trace through
