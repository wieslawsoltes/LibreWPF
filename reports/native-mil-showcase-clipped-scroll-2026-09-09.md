# Showcase clipped scrolling: application closure gate

## Acceptance action and gap

The existing `SelectorScrollViewer` in the complete package-mode Showcase is the
...
The existing isolated complete Showcase under `artifacts/native-core-showcase-build.Bb1vvF`
...
The Showcase selection and ordinary clipped-scroll paths now have the identified
