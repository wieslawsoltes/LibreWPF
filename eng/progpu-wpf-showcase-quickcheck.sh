...
echo "Running Showcase SDK apphost Application.Run self-test..."
PROGPU_WPF_SHOWCASE_REBUILD_PACKAGES=0 \
PROGPU_WPF_SHOWCASE_VALIDATE=0 \
...
echo "Running Showcase SDK apphost live geometry probe..."
PROGPU_WPF_SHOWCASE_REBUILD_PACKAGES=0 \
PROGPU_WPF_SHOWCASE_VALIDATE=0 \
PROGPU_WPF_SHOWCASE_RUN_VALIDATE=0 \
...
echo "ProGPU WPF Showcase quickcheck succeeded."
