...
The quickcheck expects the local `0.1.0-preview.42` LibreWPF package feed and its ProGPU `0.1.0-preview.51` runtime dependencies to be current. Use the full SDK CI gate when package contents need to be rebuilt from source:
